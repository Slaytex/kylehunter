...
// Checkdatek referrer is from same site.
...
<div id="nothing" style="background-color:#444444; margin-top:40px">
<center>
<b class="formthankyou">Thank you <?php if(isset($_REQUEST['name'])){print stripslashes($_REQUEST['name']);} ?>
<br />Your message has been sent</b>
<p><a href="form_iframe.html">Click here to continue</a></p>
